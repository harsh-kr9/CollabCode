    ...
    useEffect(() => {
        ...
        if (socketRef.current) {
            ...
            socketRef.current.on('received-message', ({ text, sender, senderPhoto }) => {
                ...
                setMessages(prevMessages => [...prevMessages, { text, sender, senderPhoto, sentByUser: false }]);
            });
        }
    }, [socketRef.current, meetingId, user?.uid, isDrawerOpen]);
                            ...
                            <div key={index} className={`chat ${msg.sentByUser ? 'chat-end' : 'chat-start'}`}>
                                <div className="chat-image avatar placeholder">
                                    {msg.senderPhoto ? (
                                        ...
                                        <div className="bg-primary text-primary-content rounded-full w-10 flex items-center justify-center font-bold text-sm select-none">
